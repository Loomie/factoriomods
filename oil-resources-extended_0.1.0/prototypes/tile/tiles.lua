  ...
  {
    {
      ...
      minable = {hardness = 0.2, mining_time = 0.5, result = "powerline-concrete"},
      ...
      variants =
      {
        ...
        {
          {
            picture = "__oil-resources-extended__/graphics/terrain/powerline-concrete/pl-concrete1.png",
            count = 16,
            size = 1
          },
          {
            picture = "__oil-resources-extended__/graphics/terrain/powerline-concrete/pl-concrete2.png",
            count = 4,
            size = 2,
            probability = 0.39,
          },
          {
            picture = "__oil-resources-extended__/graphics/terrain/powerline-concrete/pl-concrete4.png",
            count = 4,
            size = 4,
            probability = 1,
          },
