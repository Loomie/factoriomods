...
-- Mixer  
  {
    ...
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "mixing-plant"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    animation =
    {
      filename = "__oil-resources-extended__/graphics/entity/mixing-plant/mixing-plant-anim.png",
      priority = "high",
      width = 99,
      height = 102,
      frame_count = 8,
...
-- Multi-Fuel-Boiler  
  {
    ...
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "multi-fuel-boiler"},
    max_health = 250,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    resistances =
    ...
    animation =
    {
      filename = "__oil-resources-extended__/graphics/entity/multi-fuel-boiler/multi-fuel-boiler-anim.png",
      priority = "high",
      width = 99,
      height = 102,
      frame_count = 8,
